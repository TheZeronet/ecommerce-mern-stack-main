...
export const fetchProductsController = async (req, res) => {
  try {
    ...
    const all_products = [
      {
        ...
        maker: "Atlus game",
        imgURL:
          "https://personacentral.com/wp-content/uploads/2023/08/P3R-Key-Art.jpg",
      ...
      },
      {
        ...
        maker: "Wooden madan mohan",
        imgURL:
          "https://lsmedia.linker-cdn.net/255730/2022/7245443.jpeg?width=442&height=590",
      ...
      },
      {
        ...
        maker: "Wooden Diya",
        imgURL:
          "https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcT1q-O7-x9GGAeJDHRKfHWl7wiDavF6dpEom_zx4kray2cpqqUMtWd8Y6ebj_UtT7r9u7kmJZ4F4IfaoVOJRB39pf84EGSpAQPtrwUNfnykuNaoeDpJgqx_&usqp=CAE",
    ...
    // Move this outside the loop to send the response after all products are processed
